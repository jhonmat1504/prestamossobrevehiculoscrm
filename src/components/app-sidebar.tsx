...
import { LayoutDashboard, Users, Car, Receipt, BarChart3, Leaf } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className="border-t border-sidebar-border">
        <div className="flex items-center gap-2 px-2 py-3 text-sidebar-foreground/80 group-data-[collapsible=icon]:justify-center">
